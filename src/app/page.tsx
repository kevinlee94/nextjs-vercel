...
export default function Home() {
  ...
  const steps: Step[] = [
    ...
    },
    {
      ...
      content:
        "기본적인 2열 구조 레이아웃입니다. 모바일에서는 세로로, 데스크톱에서는 가로로 배치됩니다.",
    },
    {
      target: ".three-column-grid",
      content:
        "화면 크기에 따라 1열, 2열, 3열로 변화하는 반응형 그리드 레이아웃입니다.",
    },
    {
      target: ".sidebar-layout",
      content:
        "사이드바와 메인 콘텐츠 영역을 가진 일반적인 웹 페이지 구조입니다.",
    },
    {
      target: ".card-grid-layout",
      content:
        "반응형 카드 그리드 레이아웃입니다. 화면 크기에 따라 열 수가 변경됩니다.",
    },
    {
    ...
    },
    {
      ...
      content:
        "이 버튼을 클릭하면 각 레이아웃에 사용된 CSS 클래스에 대한 자세한 설명을 볼 수 있습니다.",
    },
  ];
                ...
                {showExplanations.twoColumn && (
                  <div className="mb-4 p-4 bg-gray-100 rounded">
                    <ul className="list-disc pl-5">
                      <li>
                        <code>flex flex-col md:flex-row</code>: 모바일에서는
                        세로로, 중간 크기 이상에서는 가로로 배치
                      </li>
                      <li>
                        <code>gap-4</code>: 요소 사이에 1rem(16px) 간격 추가
                      </li>
                      <li>
                        <code>flex-1</code>: 각 열이 동일한 너비를 가지도록 설정
                      </li>
                      <li>
                        <code>bg-blue-100</code>, <code>bg-green-100</code>:
                        배경색 지정
                      </li>
                      <li>
                        <code>p-4</code>: 모든 방향에 1rem 패딩 추가
                      </li>
                      <li>
                        <code>rounded</code>: 모서리를 둥글게 처리
                      </li>
                    </ul>
                  </div>
                )}
  ...
  <div className="flex-1 bg-white p-6 rounded-lg shadow-sm border border-gray-200">Column 2</div>
              ...
              <section className="three-column-grid">
                ...
                <p className="mb-4">
                  이 그리드는 화면 크기에 따라 1열, 2열, 3열로 변화하는 반응형
                  레이아웃입니다.
                </p>
                <button
                ...
                {showExplanations.threeColumn && (
                  <div className="mb-4 p-4 bg-gray-100 rounded">
                    <ul className="list-disc pl-5">
                      ...
                      <li>
                        <code>bg-red-100</code>, <code>bg-yellow-100</code>,{" "}
                        <code>bg-purple-100</code>: 배경색 지정
                      </li>
                      <li>
                        <code>p-4</code>: 모든 방향에 1rem 패딩 추가
                      </li>
  ...
  <div className="bg-purple-100 p-4 rounded">Column 3</div>
              ...
              <section className="sidebar-layout">
                ...
                <p className="mb-4">
                  이 레이아웃은 사이드바와 메인 콘텐츠 영역을 가진 일반적인 웹
                  페이지 구조를 보여줍니다.
                </p>
                <button
                ...
                {showExplanations.sidebar && (
                  <div className="mb-4 p-4 bg-gray-100 rounded">
                    <ul className="list-disc pl-5">
                      ...
                      <li>
                        <code>md:w-1/4</code>: 사이드바의 너비 설정
                      </li>
                      <li>
                        <code>bg-gray-200</code>: 사이드바의 배경색 설정
                      </li>
                      <li>
                        <code>md:w-3/4</code>: 메인 콘텐츠 영역의 너비 설정
                      </li>
                      <li>
                        <code>bg-gray-100</code>: 메인 콘텐츠 영역의 배경색 설정
                      </li>
                      <li>
                        <code>p-4</code>: 모든 방향에 1rem 패딩 추가
                      </li>
                ...
                {showExplanations.cardGrid && (
                  <div className="mb-4 p-4 bg-gray-100 rounded">
                    <ul className="list-disc pl-5">
                      ...
                      <li>
                        <code>bg-white</code>: 카드의 배경색 설정
                      </li>
                      <li>
                        <code>shadow</code>: 카드의 그림자 설정
                      </li>
                      <li>
                        <code>rounded</code>: 카드의 모서리 둥글게 처리
                      </li>
                      <li>
                        <code>p-4</code>: 카드의 패딩 설정
                      </li>
                    </ul>
                  </div>
                )}
              ...
              <section className="header-footer-layout">
                ...
                {showExplanations.headerFooter && (
                  <div className="mb-4 p-4 bg-gray-100 rounded">
                    <ul className="list-disc pl-5">
                      <li>
                        <code>flex flex-col min-h-screen</code>: 전체 화면 구조
                      </li>
                      <li>
                        <code>bg-blue-500</code>: 헤더의 배경색 설정
                      </li>
                      <li>
                        <code>text-white</code>: 헤더의 텍스트 색상 설정
                      </li>
                      <li>
                        <code>p-4</code>: 헤더의 패딩 설정
                      </li>
                      <li>
                        <code>bg-gray-100</code>: 메인 콘텐츠 영역의 배경색 설정
                      </li>
                      <li>
                        <code>p-4</code>: 메인 콘텐츠 영역의 패딩 설정
                      </li>
                      <li>
                        <code>bg-gray-800</code>: 푸터의 배경색 설정
                      </li>
                      <li>
                        <code>text-white</code>: 푸터의 텍스트 색상 설정
                      </li>
                      <li>
                        <code>p-4</code>: 푸터의 패딩 설정
                      </li>
                    </ul>
                  </div>
                )}
            ...
            <div className="space-y-12">
              ...
              <section>
                ...
                <div className="h-40 flex flex-col md:flex-row gap-4">
                  <div className="md:w-1/4 bg-gray-200 p-4 rounded">
                    Sidebar
                  </div>
                  <div className="md:w-3/4 bg-gray-100 p-4 rounded">
                    Main Content
                  </div>
                </div>
              </section>
